...
public class ClayCubeEntity extends WaterMobEntity implements IMob {
	...
	protected void defineSynchedData() {
	   ...
	   protected void setSize(int p_70799_1_, boolean p_70799_2_) {
	      ...
	      this.getAttribute(Attributes.MOVEMENT_SPEED).setBaseValue(0.13F + 0.1F * p_70799_1_);
	      this.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue(p_70799_1_);
	      if (p_70799_2_) {
		...
		public ActionResultType mobInteract(PlayerEntity p_230254_1_, Hand p_230254_2_) {
			      ...
			      if (itemstack.getItem() instanceof ShovelItem) {
			         ...
			         p_230254_1_.playSound(SoundEvents.GRAVEL_HIT, 1.0F, 0.5F);
			    	  ...
			    	  if (this.getSize() == 2)
			    	  {
			         p_230254_1_.playSound(SoundEvents.GRAVEL_HIT, 1.0F, 0.8F);
			    	  }
			    	  if (this.getSize() == 1)
			    	  {
			         p_230254_1_.playSound(SoundEvents.GRAVEL_HIT, 1.0F, 1.0F);
			    	  }
