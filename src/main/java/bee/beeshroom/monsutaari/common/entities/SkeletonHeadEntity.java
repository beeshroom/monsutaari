...
public class SkeletonHeadEntity extends MonsterEntity {
	  private int jumpTicks;
	   private int jumpDuration;
	   private boolean wasOnGround;
	   private int jumpDelayTicks;
	
	public SkeletonHeadEntity(EntityType<? extends SkeletonHeadEntity> type, World worldIn) {
		super(type, worldIn);
		// this.moveControl = new SkeletonHeadEntity.MoveHelperController(this);
		// this.xpReward = 5;
		 this.jumpControl = new SkeletonHeadEntity.JumpHelperController(this);
	      this.moveControl = new SkeletonHeadEntity.MoveHelperController(this);
	   ...
	   protected void registerGoals() {
		...
		//      this.goalSelector.addGoal(5, new WaterAvoidingRandomWalkingGoal(this, 1.0D));
		   ...
		   //   this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, IronGolemEntity.class, true));
		      ...
		      this.goalSelector.addGoal(4, new SkeletonHeadEntity.AvoidEntityGoal<>(this, IronGolemEntity.class, 10.0F, 2.2D, 2.2D));
		     ...
		     // this.goalSelector.addGoal(3, new FollowMobGoal(this, 1.0D, 3.0F, 7.0F));
		      ...
		      this.goalSelector.addGoal(4, new SkeletonHeadEntity.EvilAttackGoal(this));
		   ...
		   protected float getJumpPower() {
			   ...
			   public void customServerAiStep() {
			      ...
			      if (this.onGround) {
			         ...
			         SkeletonHeadEntity.JumpHelperController skeletonheadentity$jumphelpercontroller = (SkeletonHeadEntity.JumpHelperController)this.jumpControl;
			   ...
			   private void enableJumpControl() {
			      ((SkeletonHeadEntity.JumpHelperController)this.jumpControl).setCanJump(true);
			   }
...
water			   } */
			 ...
			 /*     public boolean canUse() {
			   ...
			   static class EvilAttackGoal extends MeleeAttackGoal {
			      public EvilAttackGoal(SkeletonHeadEntity p_i45867_1_) {
			   ...
			   public class JumpHelperController extends JumpController {
			      ...
			      public JumpHelperController(SkeletonHeadEntity p_i45863_2_) {
			         super(p_i45863_2_);
			   ...
			   static class MoveHelperController extends MovementController {
			      ...
			      public MoveHelperController(SkeletonHeadEntity p_i45862_1_) {
			         super(p_i45862_1_);
			         this.skeleton_head = p_i45862_1_;
			      }

			      public void tick() {
			         if (this.skeleton_head.onGround && !this.skeleton_head.jumping && !((SkeletonHeadEntity.JumpHelperController)this.skeleton_head.jumpControl).wantJump()) {
