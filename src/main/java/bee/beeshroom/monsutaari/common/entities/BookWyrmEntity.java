...
public class BookWyrmEntity extends MonsterEntity  implements IFlyingAnimal{
	...
	//   private static final EntityPredicate BAT_RESTING_TARGETING = (new EntityPredicate()).range(4.0D).allowSameTeam();
	   ...
	   public BookWyrmEntity(EntityType<? extends BookWyrmEntity> p_i50290_1_, World p_i50290_2_) {
	  ...
	  /* protected float getVoicePitch() {
	      return super.getVoicePitch() * 0.0F;
	   } */
