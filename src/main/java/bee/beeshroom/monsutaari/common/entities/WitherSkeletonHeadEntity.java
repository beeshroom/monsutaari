...
//also thank you for your Entity tutorial, Cy4shot
	...
	public class WitherSkeletonHeadEntity extends MonsterEntity //implements IMob 
	{
		   private boolean wasOnGround;

		   public WitherSkeletonHeadEntity(EntityType<? extends WitherSkeletonHeadEntity> p_i48552_1_, World p_i48552_2_) {
		      super(p_i48552_1_, p_i48552_2_);
		      this.moveControl = new WitherSkeletonHeadEntity.MoveHelperController(this);
		   }

		   protected void registerGoals() {
		  //    this.goalSelector.addGoal(1, new WitherSkeletonHeadEntity.FloatGoal(this));
		      this.goalSelector.addGoal(2, new WitherSkeletonHeadEntity.AttackGoal(this));
		      this.goalSelector.addGoal(3, new WitherSkeletonHeadEntity.FaceRandomGoal(this));
		      this.goalSelector.addGoal(5, new WitherSkeletonHeadEntity.HopGoal(this));
		  ...
		  //    this.goalSelector.addGoal(2, new RestrictSunGoal(this));
		    //  this.goalSelector.addGoal(3, new FleeSunGoal(this, 1.0D));
		      this.goalSelector.addGoal(4, new WitherSkeletonHeadEntity.AvoidEntityGoal<>(this, WolfEntity.class, 10.0F, 2.2D, 2.2D));
...
/*		   static class AttackGoal extends MeleeAttackGoal {
			      public AttackGoal(WitherSkeletonHeadEntity p_i45867_1_) {
		   ...
		   static class AttackGoal extends Goal {
		      private final WitherSkeletonHeadEntity skeletonhead;
		      private int growTiredTimer;

		      public AttackGoal(WitherSkeletonHeadEntity p_i45824_1_) {
		      ...
		      public boolean canUse() {
		         ...
		         if (livingentity == null) {
		            ...
		            return livingentity instanceof PlayerEntity && ((PlayerEntity)livingentity).abilities.invulnerable ? false : this.skeletonhead.getMoveControl() instanceof WitherSkeletonHeadEntity.MoveHelperController;
		         }
		      }
		      ...
		      public void tick() {
		         ...
		         ((WitherSkeletonHeadEntity.MoveHelperController)this.skeletonhead.getMoveControl()).setDirection(this.skeletonhead.yRot, this.skeletonhead.isDealsDamage());
		      }
		   } 
		   ...
		   static class FaceRandomGoal extends Goal {
		      ...
		      public FaceRandomGoal(WitherSkeletonHeadEntity p_i45820_1_) {
		         this.skeletonhead = p_i45820_1_;
		         this.setFlags(EnumSet.of(Goal.Flag.LOOK));
		      }

		      public boolean canUse() {
		         return this.skeletonhead.getTarget() == null && (this.skeletonhead.onGround || this.skeletonhead.isInWater() || this.skeletonhead.isInLava() || this.skeletonhead.hasEffect(Effects.LEVITATION)) && this.skeletonhead.getMoveControl() instanceof WitherSkeletonHeadEntity.MoveHelperController;
		      }
		      ...
		      public void tick() {
		         ...
		         ((WitherSkeletonHeadEntity.MoveHelperController)this.skeletonhead.getMoveControl()).setDirection(this.chosenDegrees, false);
		      }
		   }
		   ...
		   static class HopGoal extends Goal {
		      ...
		      public HopGoal(WitherSkeletonHeadEntity p_i45822_1_) {
		      ...
		      public void tick() {
		         ((WitherSkeletonHeadEntity.MoveHelperController)this.skeletonhead.getMoveControl()).setWantedMovement(1.0D);
		//          ((WitherSkeletonHeadEntity.MoveHelperController)this.skeletonhead.getMoveControl()).setWantedMovement(0.2D);
		      }
		   }
		   ...
		   static class MoveHelperController extends MovementController {
		      ...
		      public MoveHelperController(WitherSkeletonHeadEntity p_i45821_1_) {
		         super(p_i45821_1_);
		   ...
		   static class AvoidEntityGoal<T extends LivingEntity> extends net.minecraft.entity.ai.goal.AvoidEntityGoal<T> {
			      private final WitherSkeletonHeadEntity wither_skeleton_head;

			      public AvoidEntityGoal(WitherSkeletonHeadEntity p_i46403_1_, Class<T> p_i46403_2_, float p_i46403_3_, double p_i46403_4_, double p_i46403_6_) {
			         super(p_i46403_1_, p_i46403_2_, p_i46403_3_, p_i46403_4_, p_i46403_6_);
			         this.wither_skeleton_head = p_i46403_1_;
			      }
			   }
		}