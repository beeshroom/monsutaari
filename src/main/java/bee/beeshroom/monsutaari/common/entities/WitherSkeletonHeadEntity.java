...
public class WitherSkeletonHeadEntity extends MonsterEntity {
	  private int jumpTicks;
	   private int jumpDuration;
	   private boolean wasOnGround;
	   private int jumpDelayTicks;
	
	public WitherSkeletonHeadEntity(EntityType<? extends WitherSkeletonHeadEntity> type, World worldIn) {
		super(type, worldIn);
		// this.moveControl = new SkeletonHeadEntity.MoveHelperController(this);
		// this.xpReward = 5;
		 this.jumpControl = new WitherSkeletonHeadEntity.JumpHelperController(this);
	   ...
	   protected void registerGoals() {
		...
		//      this.goalSelector.addGoal(5, new WaterAvoidingRandomWalkingGoal(this, 1.0D));
		   ...
		   //   this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, IronGolemEntity.class, true));
		      ...
		      this.goalSelector.addGoal(4, new WitherSkeletonHeadEntity.AvoidEntityGoal<>(this, IronGolemEntity.class, 10.0F, 2.2D, 2.2D));
		     ...
		     // this.goalSelector.addGoal(3, new FollowMobGoal(this, 1.0D, 3.0F, 7.0F));
		      ...
		      this.goalSelector.addGoal(4, new WitherSkeletonHeadEntity.EvilAttackGoal(this));
		   ...
		   protected float getJumpPower() {
			   ...
			   public void customServerAiStep() {
			      ...
			      if (this.onGround) {
			         ...
			         WitherSkeletonHeadEntity.JumpHelperController skeletonheadentity$jumphelpercontroller = (WitherSkeletonHeadEntity.JumpHelperController)this.jumpControl;
			   ...
			   private void enableJumpControl() {
			      ((WitherSkeletonHeadEntity.JumpHelperController)this.jumpControl).setCanJump(true);
			   }

			   private void disableJumpControl() {
			      ((WitherSkeletonHeadEntity.JumpHelperController)this.jumpControl).setCanJump(false);
			   }
			...
			/*   public boolean doHurtTarget(Entity p_70652_1_) {
			 ...
			 /*     public boolean canUse() {
			   ...
			   static class EvilAttackGoal extends MeleeAttackGoal {
			      public EvilAttackGoal(WitherSkeletonHeadEntity p_i45867_1_) {
			         super(p_i45867_1_, 1.4D, true);
			      }

			      protected double getAttackReachSqr(LivingEntity p_179512_1_) {
			         return (double)(1.0F + p_179512_1_.getBbWidth());
			      }
			   }
			   ...
			   public class JumpHelperController extends JumpController {
			      ...
			      public JumpHelperController(WitherSkeletonHeadEntity p_i45863_2_) {
			         super(p_i45863_2_);
			   ...
			   static class MoveHelperController extends MovementController {
			      ...
			      public MoveHelperController(WitherSkeletonHeadEntity p_i45862_1_) {
			         super(p_i45862_1_);
			         this.skeleton_head = p_i45862_1_;
			      }

			      public void tick() {
			         if (this.skeleton_head.onGround && !this.skeleton_head.jumping && !((WitherSkeletonHeadEntity.JumpHelperController)this.skeleton_head.jumpControl).wantJump()) {
