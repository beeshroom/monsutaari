...
public class HeadlessSkeletonModel<T extends MobEntity & IRangedAttackMob> extends BipedModel<T> {
   
	public HeadlessSkeletonModel() {
      this(0.0F, false);
   }

   public HeadlessSkeletonModel(float p_i46303_1_, boolean p_i46303_2_) {
      super(p_i46303_1_);
      if (!p_i46303_2_) {
