...
@OnlyIn(Dist.CLIENT)
//public class SkeletonHeadModel<T extends SkeletonHeadEntity> extends EntityModel<T> {
public class HeadlessWitherSkeletonModel<T extends MobEntity & IRangedAttackMob> extends BipedModel<T> {
   
	public HeadlessWitherSkeletonModel() {
      this(0.0F, false);
   }

   public HeadlessWitherSkeletonModel(float p_i46303_1_, boolean p_i46303_2_) {
      super(p_i46303_1_);
      if (!p_i46303_2_) {
    	//  this.head = new ModelRenderer(this, 0, 0);
        //  this.head.addBox(9990F, 999F, 999F, 999F, 999F, 999F, 999F);
