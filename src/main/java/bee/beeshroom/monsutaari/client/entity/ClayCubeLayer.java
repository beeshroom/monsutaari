...
@OnlyIn(Dist.CLIENT)
public class ClayCubeLayer<T extends LivingEntity> extends LayerRenderer<T, ClayCubeModel<T>> {
   private final EntityModel<T> model = new ClayCubeModel<>(0);

   public ClayCubeLayer(IEntityRenderer<T, ClayCubeModel<T>> p_i50923_1_) {
      super(p_i50923_1_);
   }
