...
@OnlyIn(Dist.CLIENT)
public class SnowCubeLayer<T extends LivingEntity> extends LayerRenderer<T, SnowCubeModel<T>> {
   private final EntityModel<T> model = new SnowCubeModel<>(0);

   public SnowCubeLayer(IEntityRenderer<T, SnowCubeModel<T>> p_i50923_1_) {
      super(p_i50923_1_);
   }
