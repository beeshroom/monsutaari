//decided they arent transparent 
...
@OnlyIn(Dist.CLIENT)
public class WispLayer<T extends LivingEntity> extends LayerRenderer<T, WispModel<T>> {
   private final EntityModel<T> model = new WispModel<>(0);

   public WispLayer(IEntityRenderer<T, WispModel<T>> p_i50923_1_) {
      super(p_i50923_1_);
   }
